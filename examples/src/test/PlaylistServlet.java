...
public class PlaylistServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            throw new ServletException("application not properly configured",
                    ex);
        }
        ...
        if (type.equals("m3u")) {
            ...
            while (it.hasNext()) {
                ...
                String url = isLocal ? (source + File.separator + fn)
                        : (urlPrefix + pathInfoEncode(fn) + "." + outputType);

                // track info
                File t = new File(source + File.separator + fn);
                out.println("#EXTINF:" + getTrackLength(t) + ","
                        + getTrackTitle(t));
            ...
            out.println("<TITLE>Playlist of type: '" + type
                    + "' NOT YET IMPLEMENTED</TITLE>");
            out.println("</HEAD><BODY>");
            out.println("<H1>Playlist of type: '" + type
                    + "' NOT YET IMPLEMENTED</H1>");
