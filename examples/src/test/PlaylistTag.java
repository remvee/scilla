...
/**
 * The playlist tag puts an url to a playlist servlet into an JSP attributes.
 * 
...
public class PlaylistTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            if (listtype != null) {
                ...
                String t = (String) pageContext
                        .findAttribute(LIST_TYPE_ATTRIBUTE);
                if (t != null) {
                    out.append(t);
                } else {
            ...
            if (obj instanceof DirectoryBean) {
                ...
                String fname = ((AudioInfo) obj)
                        .getString(DirectoryBean.LOCATION_KEY);
                out.append(URLEncoder.encode(fname));
            } else {
            ...
            if (streamtype != null) {
                ...
                String t = (String) pageContext
                        .findAttribute(STREAM_TYPE_ATTRIBUTE);
                if (t != null) {
                    out.append(t);
                } else {
            ...
            url = ((HttpServletResponse) pageContext.getResponse())
                    .encodeURL(url);
    ...
    /**
     * @param v
     *            name of attribute containing directory or track bean
     */
    ...
    /**
     * @param v
     *            name of attribute to put url in
     */
    ...
    /**
     * @param v
     *            recursive option, set to <tt>true</tt> of recursion
     */
    ...
    /**
     * @param v
     *            type of playlist, i.e. <tt>m3u</tt> or <tt>pls</tt>
     */
    ...
    /**
     * @param v
     *            type of stream, i.e. <tt>ogg</tt> or <tt>mp3</tt>
     */
    ...
    /**
     * @param v
     *            JSP scope to put <tt>var</tt> attribute in
     */
    ...
    private int getScopeInt() throws JspException {
        ...
        } else if ("application".equalsIgnoreCase(scope)) { return PageContext.APPLICATION_SCOPE; }
