...
public class ID3v2 {
    ...
    throws IOException, Exception {
        ...
        if (unsyncFlag) {
            data = unsyncArray(data);
        }

        // add padding
        if (padding > 0) {
            data = addPadding(data, padding);
        }
    ...
    /**
     * Set given frame as only frame with ID of given frame.
     * @param frame frame to replace all existing frames of it's
     * kind.
     */
